...
public class TestZaraRESTAPI {
	...
	public void test1() throws Exception {
		...
		URI uri = new URI("http://localhost:" + randomServerPort
				+ "/Prices?applyDate=2020-06-14-10.00.00&productId=35455&brandId=1");
	...
	public void test2() throws Exception {
		RestTemplate restTemplate = new RestTemplate();
		URI uri = new URI("http://localhost:" + randomServerPort
				+ "/Prices?applyDate=2020-06-14-16.00.00&productId=35455&brandId=1");
		Price price = restTemplate.getForObject(uri, Price.class);
		Assertions.assertNotNull(price.getPrice_list());
	...
	public void test3() throws Exception {
		RestTemplate restTemplate = new RestTemplate();
		URI uri = new URI("http://localhost:" + randomServerPort
				+ "/Prices?applyDate=2020-06-14-21.00.00&productId=35455&brandId=1");
		Price price = restTemplate.getForObject(uri, Price.class);
		Assertions.assertNotNull(price.getPrice_list());
	...
	public void test4() throws Exception {
		RestTemplate restTemplate = new RestTemplate();
		URI uri = new URI("http://localhost:" + randomServerPort
				+ "/Prices?applyDate=2020-06-15-10.00.00&productId=35455&brandId=1");
		Price price = restTemplate.getForObject(uri, Price.class);
		Assertions.assertNotNull(price.getPrice_list());
	...
	public void test5() throws Exception {
		RestTemplate restTemplate = new RestTemplate();
		URI uri = new URI("http://localhost:" + randomServerPort
				+ "/Prices?applyDate=2020-06-16-21.00.00&productId=35455&brandId=1");
		Price price = restTemplate.getForObject(uri, Price.class);
		Assertions.assertNotNull(price.getPrice_list());
